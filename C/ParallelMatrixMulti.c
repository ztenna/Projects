// Zachary Tennant
// File Name: ParallelMatrixMulti.c
...
//                      third and so on. In this version, some of the code is parallelized to run on the GPU
...
void writeToFile(FILE *file, int matrix1Row, int matrix2Col, int productMatrix[][1000]);//int **productMatrix);
...
#pragma acc parallel loop copyin(matrix1[0:matrix1Row*matrix1Col]) copyin(matrix2[0:matrix2Row*matrix2Col]) copyout(productMatrix[0:matrix1Row*matrix2Col])
